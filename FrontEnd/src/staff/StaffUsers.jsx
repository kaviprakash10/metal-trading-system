...
import { fetchAllUsers, deleteUser } from "../slice/Adminslice";
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {u.authProvider === 'google' && (
                              <div className="w-4 h-4 bg-white rounded-full flex items-center justify-center p-0.5 border border-slate-100 shadow-sm" title="Google User">
                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-3">
                          ...
                          {selected.authProvider === 'google' && (
                            <div className="p-1 px-3 bg-white text-slate-900 rounded-lg font-black text-[10px] uppercase tracking-widest border border-slate-200 flex items-center gap-2 shadow-sm">
