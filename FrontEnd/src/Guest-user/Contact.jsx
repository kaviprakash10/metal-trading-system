      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20 animate-fade-in">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto font-light">
            Whether you're a first-time investor or a seasoned professional, our
            team is here to guide your gold journey.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <form className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white focus:border-amber-500/30 focus:ring-4 focus:ring-amber-500/5 transition-all outline-none"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-400 uppercase tracking-widest ml-1">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-6 py-4 rounded-3xl bg-gray-50 border-transparent focus:bg-white focus:border-amber-500/30 focus:ring-4 focus:ring-amber-500/5 transition-all outline-none resize-none"
                ></textarea>
              </div>
          ...
          <div className="lg:col-span-5 space-y-12 animate-slide-up [animation-delay:200ms]">
              ...
              {[
                {
                  ...
                  detail:
                    "Luna Gold Towers, Race Course, Coimbatore, TN 641018",
                },
                {
                  icon: "📞",
                  title: "Support Line",
                  detail: "+91 (0422) 488 9000",
                },
            ...
            <div className="p-10 rounded-[40px] bg-gradient-to-br from-amber-900 to-black text-white relative overflow-hidden group">
              ...
              <p className="text-amber-400 font-bold uppercase tracking-widest text-xs mb-4">
                Enterprise Inquiries
              </p>
              <h4 className="text-2xl font-bold mb-4 leading-tight">
                Looking for large-scale procurement?
              </h4>
              <p className="text-gray-400 font-light mb-8">
                Talk to our institutional desk for bulk digital and physical
                gold solutions.
              </p>
